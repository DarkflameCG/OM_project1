		...
		<ul>
			...
			<li class="nav-item"><a href="javascript:;"><i
				...
				<ul>
					...
					<!--只有主管和高管才有销售机会管理   -->
					<li onclick=""><a href="sale/showSaleChanceView" target="mainFrame"><span>销售机会管理</span></a></li>
					</c:if>
			
					<c:if test="${sessionScope.user.usrRoleId==4||sessionScope.user.usrRoleId==2}">
					<!--只有经理和高管才有客户开发计划  -->
					<li onclick=""><a href="sale/showSaleChanceView" target="mainFrame"><span>客户开发计划</span></a></li>
					</c:if>
			...
			<li class="nav-item"><a href="javascript:;"><i
					...
					class="my-icon nav-more"></i></a>
				<ul>
					<li onclick="forward('cust/1/findAllCustomer')"><a 
			...
			<li class="nav-item"><a href="javascript:;"><i
					...
					class="my-icon nav-more"></i></a>
				<ul>
					<li onclick=""><a href="custservice/service_add"
						target="mainFrame"><span>服务创建</span></a></li>
					<li onclick=""><a href="custservice/service_dispatch"
						target="mainFrame"><span>服务分配</span></a></li>
					<li onclick=""><a href="custservice/service_deal"
						target="mainFrame"><span>服务处理</span></a></li>
					<li onclick=""><a href="custservice/service_feedback"
			...
			<!--只有管理员 高管 主管有  -->
				<c:choose>
				<c:when test="${sessionScope.user.usrRoleId<4}">
			<li class="nav-item"><a href="javascript:;"><i
					class="my-icon nav-icon icon-alarm"></i><span>统计报表</span><i
					class="my-icon nav-more"></i></a>
				<ul>
					<li onclick=""><a href="report/contr"
						target="mainFrame"><span>客户贡献分析</span></a></li>
					<li onclick=""><a href="report/cons?condit=0"
			...
			<li class="nav-item"><a href="javascript:;"><i
					...
					class="my-icon nav-more"></i></a>
				<ul>
					<li onclick=""><a href="basic/product" target="mainFrame"><span>查询产品信息</span></a></li>
					<li onclick=""><a href="basic/storage" target="mainFrame"><span>查询库存</span></a></li>
				</ul></li>
			...
			<li class="nav-item"><a href="javascript:;"><i
				...
				<ul>
					...
					<li onclick=""><a href="sysuser/user_manage"
