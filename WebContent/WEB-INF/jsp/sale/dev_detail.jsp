...
/* 		request.getScheme();//协议名称http
		request.getServerName();//服务器的名字，主机地址 localhost
		request.getServerPort();//端口号 8888
		request.getContextPath();//工程名字 项目名字 */
	...
	<tr>
    	<td width=100% height=32 align=center colspan=6 bgcolor=#ffffff>
        	<a href="help"><input class="common_button"  type="button" value="帮助"></a>&nbsp;&nbsp;&nbsp;
			    <a href=""><input class="common_button"  type="button" value="返回"></a>
        </td>
    </tr>
</table>
<br />
...
<table class="data_list_table" id="table1" cellSpacing=1 cellPadding=1>
	...
	<tr>
		<td class="list_data_text" align="center"><a href="#loginmodal" class="modaltrigger"><img src="../../images/bt_edit.png"></a></td>
		<td class="list_data_text" align="center"></td>
	</tr>
	</table>
...
<div id="loginmodal" style="display:none;">
    ...
    <form id="loginform" name="loginform" method="post" action="">
      <input type="hidden" name="pla_chc_id" value="">
