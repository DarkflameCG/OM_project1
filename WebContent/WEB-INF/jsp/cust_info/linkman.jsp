	...
	<table class="query_form_table" cellSpacing=1 cellPadding=1>
		...
		<tr>
			<td colspan="4" align="center"><a href="help"><input
				...
				<a href="cust/addLinkMan"><button class="common_button" type="button">新建</button></a>&nbsp;&nbsp;
				<input class="common_button" type="button" value="返回" onclick="back()"></td>
		</tr>
	</table>
	<br />
	<table class="data_list_table" cellSpacing=1 cellPadding=1>
		<tr>
			...
			<tr>
				...
				<img
					onClick="to('cust/editLinkMan');" title="编辑"
